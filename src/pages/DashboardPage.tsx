          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Bem-vindo de volta, {user.name || user.email}!</p>
              </div>
            </div>
        ...
        <div className="card p-6">
          ...
          {habits.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">Nenhum hábito criado ainda. Comece a construir melhores hábitos hoje!</p>
                  ...
                  <div key={habit.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{habit.streak} dias de sequência</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2">
                      ...
                      <CheckCircle2 className={`w-5 h-5 ${completed ? 'text-green-600' : 'text-gray-300'}`} />
                    </div>
                  </div>
                )
              })}
